...
TODO: Add long description of the pod here.
  ...
  s.subspec 'Base' do |sp|
     ...
     sp.ios.vendored_frameworks = 'OMTSocial-0.0.3/ios/OMTSocial.framework'
     sp.public_header_files = 'OMTSocial-0.0.3/ios/OMTSocial.framework/Versions/A/**/OMTSocial.h'
     sp.source_files = 'OMTSocial-0.0.3/ios/OMTSocial.framework/Versions/A/**/OMTSocial.h'
     sp.preserve_paths = 'OMTSocial-0.0.3/ios/OMTSocial.framework'
  ...
  s.subspec 'Facebook' do |sp|
     ...
     sp.public_header_files = 'OMTSocialFacebook-0.0.2/ios/OMTSocialFacebook.framework/Versions/A/**/*.h'
     sp.source_files = 'OMTSocialFacebook-0.0.2/ios/OMTSocialFacebook.framework/Versions/A/**/*.h'
